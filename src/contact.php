				...
				<div class="col-lg-6">
					<div class="contact_content">
						...
						<div class="contact_list">
							<ul>
								<li>M239 ถนน ห้วยแก้ว Tambon Su Thep, Amphoe Mueang Chiang Mai, Chang Wat Chiang Mai 50200, 태국</li>
						...
						<div class="contact_form_container">
							<form action="send_inbox.php" method="POST" class="contact_form" id="contact_form">
								...
								<div class="input_container"><textarea class="contact_input contact_textarea" name="message" placeholder="Message" required="required"></textarea></div>
